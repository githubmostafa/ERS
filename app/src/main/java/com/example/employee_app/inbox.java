...
public class inbox extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listViewAds = findViewById(R.id.listView_resumes);
        Intent employeeApprove = new Intent (inbox.this,approve_emp.class);
        ...
        reference = db.getReference("Resumes").child(output);
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                resume_list resumeAdapter = new resume_list(inbox.this,resumes);
        ...
        listViewAds.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Resume resume = resumes.get(position);
                        ...
                        employeeApprove.putExtra("resumeid",resumeid);
    ...
    public void backToAdmin(View view){
        Intent inbox = new Intent(com.example.employee_app.inbox.this,admin.class);
        startActivity(inbox);
    }
}